...
drone1 <- read_excel("UASEventsNov2014-Aug2015.xls")
drone2 <- read_excel("UAS_Sightings_report_21Aug-31Jan.xlsx")
...
- You can find the code for this page [here](https://github.com/seankross/seankross.github.io/tree/master/notes/drones).
- [Get in touch!](http://twitter.com/seankross)
