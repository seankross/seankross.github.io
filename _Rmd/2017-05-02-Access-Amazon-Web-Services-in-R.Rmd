...
```{r, echo=FALSE}
library(knitr)
include_graphics("../img/2017-05-02-Access-Amazon-Web-Services-in-R/service-search.png")
```
...
```{r, echo=FALSE}
include_graphics("../img/2017-05-02-Access-Amazon-Web-Services-in-R/iam-dashboard.png")
```
...
```{r, echo=FALSE}
include_graphics("../img/2017-05-02-Access-Amazon-Web-Services-in-R/add-user.png")
```
...
```{r, echo=FALSE}
include_graphics("../img/2017-05-02-Access-Amazon-Web-Services-in-R/add-jeff.png")
```
...
```{r, echo=FALSE}
include_graphics("../img/2017-05-02-Access-Amazon-Web-Services-in-R/permissions.png")
```
...
```{r, echo=FALSE}
include_graphics("../img/2017-05-02-Access-Amazon-Web-Services-in-R/s3.png")
```
...
```{r, echo=FALSE}
include_graphics("../img/2017-05-02-Access-Amazon-Web-Services-in-R/secret.png")
```
